stdsettings="--v1 --maxrecdepth 1 --gen_method newtrav --trav_type striped --trav_priority sfs --to 1000 --no-save-lemmas --inv-templ 0"
...
mkdir -p logs
exec > logs/log-$nowtime.txt 2>&1
ln -sf log-$nowtime.txt logs/log-latest.txt
